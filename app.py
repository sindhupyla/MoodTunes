...
# Update the file path for the CSV
df = pd.read_csv("C:\\Users\\DELL\\Desktop\\MoodTunes\\MoodTunes\\muse_v3.csv")
...
# Model setup with updated path for model weights
model = Sequential()
...
# Update the model weights path
model.load_weights('C:\\Users\\DELL\\Desktop\\MoodTunes\\MoodTunes\\model.h5')
...
# Update the path for Haarcascade classifier
face = cv2.CascadeClassifier('C:\\Users\\DELL\\Desktop\\MoodTunes\\MoodTunes\\haarcascade_frontalface_default.xml')
if face.empty():
...
st.markdown("<h2 style='text-align: center; color: white'><b>Mood Tunes</b></h2>"
